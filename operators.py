# permet d'importer une librairie externe de python
import random
import math
...
# mais l'opérateur ++ n'existe pas en python mais en JavaScript et php)
...
# % modulo
foo = 4 % 3
# génère un nombre aléatoire comprit entre 2 limites
...
# à ne pas confondre avec l'identité === (qui n'existe pas en python mais en JavaScript)
result = 1 == 1.0
print(result)
...
# on peut utiliser d'autres types de données que l'on convertit en booléen avec les opérateurs booléens
